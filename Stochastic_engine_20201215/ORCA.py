...
#    os.makedirs(results_folder)
    ...
    for k in range(start, stop):
      ...
      print('Sample ' + str(k) + ' start', file=sys.stderr)
      sys.stdout.flush()
      ...
      if model_mode == 'sensitivity':
        ...
        for t in range(0,timeseries_length):
          ...
          if (t % 365 == 364):
            print('Year ', (t+1)/365, ', ', datetime.now() - startTime, file=sys.stderr)
            # sys.stdout.flush()
    ...
    combined0 = np.column_stack((noresR*504.51198,soresR*504.51198)); # results from Oct 01 to next Sep 31 e.g., 1901/10/01~1999/09/31
    combined = combined0[93:-273]; # results from next Jan 01 to Dec 31 of the second last year e.g., 1902/01/01~1998/12/31
