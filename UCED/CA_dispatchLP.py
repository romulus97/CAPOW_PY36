...
def SysCost(model):
    ...
    return fixed + coal1 + coal2 + coal3 + gas1_1 + gas1_2 + gas1_3 + gas1_4 + gas2_1 + gas2_2 + gas2_3 + gas2_4 + gas3_1 + gas3_2 + gas3_3 + gas3_4 + sce_imports1 + sce_imports2 + sce_imports3 + sdge_imports1 + sdge_imports2 + sdge_imports3 + pgev_imports1 + pgev_imports2 + pgev_imports3 + oil1 + oil2 + oil3 + psh1 + psh2 + psh3 +solar + wind+ slack1 + slack2 + slack3 + starts + exchange
